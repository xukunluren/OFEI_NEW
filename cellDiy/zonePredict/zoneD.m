...
- (void)drawRect:(CGRect)rect {
        UIView *view24H = [[UIView alloc]initWithFrame:CGRectMake(10, self.bounds.size.height*0.41, self.bounds.size.width-20, self.bounds.size.height/6)];
    view24H.layer.cornerRadius = 10;
    view24H.layer.masksToBounds = YES;
    view24H.backgroundColor = [UIColor blackColor];
    view24H.alpha = 0.4;
    UIImageView *time24 = [[UIImageView alloc]initWithFrame:CGRectMake(self.bounds.size.width/2-20, self.bounds.size.height*0.38, self.bounds.size.width/9, self.bounds.size.width/9)];
    [time24 setImage:[UIImage imageNamed:@"time24.png"]];
    [self addSubview:view24H];
    [self addSubview:time24];
    UILabel *contentWind = [[UILabel alloc]initWithFrame:CGRectMake(self.bounds.size.width/4, self.bounds.size.height*0.41, 100, 40)];
    contentWind.text = @"风";
    ...
    UILabel *windUnit = [[UILabel alloc]initWithFrame:CGRectMake(self.bounds.size.width*0.3, self.bounds.size.height*0.45, 100, 40)];
    windUnit.text = @"级";
    ...
    UILabel *waveContent = [[UILabel alloc]initWithFrame:CGRectMake(self.bounds.size.width*0.73, self.bounds.size.height*0.41, 100, 40)];
    waveContent.text = @"浪";
    ...
    //风等级
    _wind = [[UILabel alloc]initWithFrame:CGRectMake(self.bounds.size.width*0.08, self.bounds.size.height*0.45, 100, 40)];
    ...
    //方向设置
    _windDirection = [[UILabel alloc]initWithFrame:CGRectMake(self.bounds.size.width*0.2, self.bounds.size.height*0.5, 100, 40)];
    ...
    //浪
    _wave = [[UILabel alloc]initWithFrame:CGRectMake(self.bounds.size.width*0.7, self.bounds.size.height*0.45, 200, 40)];
    _wave.textColor = [UIColor whiteColor];
    _wave.font = [UIFont fontWithName:@"Arial-BoldItalicMT" size:16];
    [self addSubview:_wave];
    
    _waveDirection  = [[UILabel alloc]initWithFrame:CGRectMake(self.bounds.size.width*0.75, self.bounds.size.height*0.5, 100, 40)];
    ...
    UIView *view48H = [[UIView alloc]initWithFrame:CGRectMake(10, kheight*0.61, kwidth-20, kheight/6)];
    view48H.layer.cornerRadius = 10;
    view48H.layer.masksToBounds = YES;
    view48H.backgroundColor = [UIColor blackColor];
    view48H.alpha = 0.4;
    UIImageView *time48 = [[UIImageView alloc]initWithFrame:CGRectMake(kwidth/2-20, kheight - kheight/2.5-kwidth/18+10, kwidth/9, kwidth/9)];
    [time48 setImage:[UIImage imageNamed:@"time48.png"]];
    [self addSubview:view48H];
    [self addSubview:time48];
    
    UILabel *contentWind_48 = [[UILabel alloc]initWithFrame:CGRectMake(kwidth/4, kheight*0.61, 100, 40)];
    ...
    UILabel *windUnit_48 = [[UILabel alloc]initWithFrame:CGRectMake(kwidth*0.3, kheight*0.65, 100, 40)];
    windUnit_48.text = @"级";
    ...
    UILabel *waveContent_48 = [[UILabel alloc]initWithFrame:CGRectMake(kwidth*0.73, kheight*0.61, 100, 40)];
    ...
    //风等级
    _wind_48 = [[UILabel alloc]initWithFrame:CGRectMake(kwidth*0.08, kheight*0.65, 100, 40)];
    ...
    //方向设置
    _windDirection_48 = [[UILabel alloc]initWithFrame:CGRectMake(kwidth*0.2, kheight*0.7, 100, 40)];
    ...
    //浪
    _wave_48 = [[UILabel alloc]initWithFrame:CGRectMake(kwidth*0.7, kheight*0.65, 200, 40)];
    ...
    _waveDirection_48 = [[UILabel alloc]initWithFrame:CGRectMake(kwidth*0.75, kheight*0.7, 100, 40)];
    ...
    //72h信息
    UIView *view72H = [[UIView alloc]initWithFrame:CGRectMake(10,kheight-kheight/6-15, kwidth-20, kheight/6)];
    view72H.layer.cornerRadius = 10;
    view72H.layer.masksToBounds = YES;
    view72H.backgroundColor = [UIColor blackColor];
    view72H.alpha = 0.4;
    UIImageView *time72 = [[UIImageView alloc]initWithFrame:CGRectMake(kwidth/2-20,kheight-kheight/6-kwidth/18-10,kwidth/9, kwidth/9)];
    [time72 setImage:[UIImage imageNamed:@"time72.png"]];
    [self addSubview:view72H];
    [self addSubview:time72];
    
    UILabel *contentWind_72 = [[UILabel alloc]initWithFrame:CGRectMake(kwidth/4, kheight*0.81, 100, 40)];
    ...
    UILabel *windUnit_72 = [[UILabel alloc]initWithFrame:CGRectMake(kwidth*0.3, kheight*0.85, 100, 40)];
    windUnit_72.text = @"级";
    ...
    UILabel *waveContent_72 = [[UILabel alloc]initWithFrame:CGRectMake(kwidth*0.73, kheight*0.81, 100, 40)];
    ...
    //风等级
    _wind_72 = [[UILabel alloc]initWithFrame:CGRectMake(kwidth*0.08, kheight*0.85, 100, 40)];
    ...
    //方向设置
    _windDirection_72 = [[UILabel alloc]initWithFrame:CGRectMake(kwidth*0.2, kheight*0.9, 100, 40)];
    ...
    //浪
    _wave_72 = [[UILabel alloc]initWithFrame:CGRectMake(kwidth*0.7, kheight*0.85, 200, 40)];
    ...
    _waveDirection_72 = [[UILabel alloc]initWithFrame:CGRectMake(kwidth*0.75, kheight*0.9, 100, 40)];
